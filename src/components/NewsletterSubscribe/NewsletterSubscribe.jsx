    ...
    >
      <div className="container mx-auto max-w-xl text-center bg-white/90 backdrop-blur-sm p-8 md:p-12 rounded-lg shadow-xl">
        ...
        <p className="text-light-text mb-8 text-base lg:text-lg">
          Digete seu e-mail para ficar sabendo sobre lançamentos e novidades
        </p>
        <form className="flex flex-col sm:flex-row justify-center items-center gap-3 max-w-md mx-auto">
          ...
          <button
            type="submit"
            className="bg-brand text-black font-semibold py-3.5 px-8 rounded-md hover:bg-brand-light hover:text-heading-text transition-all duration-300 w-full sm:w-auto text-sm uppercase tracking-wider shadow-md hover:shadow-lg"
          >
            Enviar
          </button>
        </form>
