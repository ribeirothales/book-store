    ...
    <section className="bg-white py-16 lg:py-24 px-6 md:px-12 lg:px-24">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
        ...
        <div className="lg:w-3/5 text-center lg:text-left">
          ...
          <p className="text-3xl lg:text-4xl font-bold text-brand mb-6 lg:mb-8">$ 45.00</p>
          <a href="#" className="inline-block bg-heading-text text-white font-semibold py-3.5 px-10 rounded hover:bg-brand transition-all duration-300 text-sm uppercase tracking-wider">
            Shop it now
          </a>
        </div>
      </div>
