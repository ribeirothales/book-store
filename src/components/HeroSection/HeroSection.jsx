...
const HeroSection = () => {
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between h-full gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 order-2 lg:order-1 text-center lg:text-left">
            ...
            <div className="max-w-2xl mx-auto lg:mx-0">
              ...
              <a
                href="#"
                className="inline-block bg-transparent border-4 border-[#D3BFA0] text-[#A07C43] font-semibold py-2 sm:py-3 px-6 sm:px-8 md:px-10 rounded hover:bg-[#D3BFA0] hover:text-white transition-colors duration-300 mb-20 sm:mb-12"
              >
      ...
      <div className="sm:hidden absolute bottom-14 left-1/2 transform -translate-x-1/2 text-gray-500 text-xs flex items-center">
